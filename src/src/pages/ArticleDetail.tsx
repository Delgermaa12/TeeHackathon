...
const ArticleDetail: React.FC = () => {
    ...
    if (!article) {
        return (
            <div className={`min-h-screen flex items-center justify-center px-6 ${theme === 'dark' ? 'bg-brand-dark text-white' : 'bg-brand-light text-black'}`}>
                <div className="text-center space-y-6">
                    <h1 className="text-3xl md:text-5xl font-black">
                        {language === 'mn' ? 'Нийтлэл олдсонгүй' : 'Article not found'}
                    </h1>
                    <button
                        onClick={() => navigate('/articles')}
                        className="px-8 py-4 rounded-2xl bg-[#eab308] text-black font-black text-xs uppercase tracking-widest"
                    >
            ...
            <main className="relative z-10">
                ...
                <nav className="fixed top-0 left-0 w-full z-50 p-6 flex justify-between items-center bg-gradient-to-b from-black/40 to-transparent">
                    <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        onClick={() => navigate('/articles')}
                        className={`flex items-center gap-3 px-6 py-3 rounded-2xl backdrop-blur-3xl border-2 ${
                            theme === 'dark'
                                ? 'bg-white/5 border-white/5 text-white hover:border-[#eab308]/40'
                                : 'bg-black/5 border-black/5 text-black hover:border-[#eab308]/40'
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        className={`p-3.5 rounded-2xl backdrop-blur-3xl border-2 ${
                            theme === 'dark'
                                ? 'bg-white/5 border-white/5 text-white hover:border-[#eab308]/40'
                                : 'bg-black/5 border-black/5 text-black hover:border-[#eab308]/40'
                        } transition-all`}
                ...
                <section className="relative h-[85vh] flex items-center justify-center overflow-hidden">
                    ...
                    <div className="max-w-5xl mx-auto px-6 relative z-10 text-center space-y-10 mt-20">
                        ...
                        <motion.div
                            ...
                            className={`flex flex-wrap justify-center items-center gap-8 text-[11px] font-black uppercase tracking-[0.2em] ${
                ...
                <section className="py-32 -mt-32 relative z-20">
                    <div className="max-w-4xl mx-auto px-6">
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className={`p-10 md:p-20 rounded-[4rem] backdrop-blur-3xl border-2 shadow-2xl ${
                                theme === 'dark'
                        ...
                        >
                            <div className={`prose prose-2xl ${theme === 'dark' ? 'prose-invert text-white' : 'text-black'} max-w-none`}>
                                ...
                                <div
                                    className={`text-lg md:text-xl leading-[1.8] space-y-10 ${
                            ...
                            >
                                ...
                                {['Education', 'Technology', 'Future'].map((tag) => (
                                    <span
                                        key={tag}
                                        className={`text-[10px] font-black uppercase tracking-widest px-5 py-2 rounded-2xl border-2 transition-all cursor-pointer ${
                                            theme === 'dark'
                                                ? 'bg-white/5 border-white/5 text-white/50 hover:border-[#eab308]/40 hover:text-white'
                                                : 'bg-black/5 border-black/5 text-black/50 hover:border-[#eab308]/40 hover:text-black'
                                        }`}
                                    >
                                        #{tag}
                                    </span>
