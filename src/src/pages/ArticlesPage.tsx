    ...
    const filteredArticles = useMemo(() => {
        return articles.filter(article => {
            ...
            const matchesCategory =
                !selectedCategory || article.category[language] === selectedCategory;
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-4 w-full lg:w-auto">
                            <div className="relative group w-full sm:w-80">
                                <Search
                                    className={`absolute left-5 top-1/2 -translate-y-1/2 transition-colors duration-300 ${
                                        searchQuery
                                            ? 'text-[#eab308]'
                                            : 'opacity-30 group-focus-within:opacity-100 group-focus-within:text-[#eab308]'
                                    }`}
                                    size={20}
                                />
                                <input
                                    ...
                                    className={`pl-14 pr-6 py-4 rounded-2xl w-full backdrop-blur-3xl border-2 transition-all outline-none text-sm font-medium ${
                                        theme === 'dark'
                            ...
                            <div className="relative w-full sm:w-60">
                                <button
                                    ...
                                    className={`flex items-center justify-between w-full px-6 py-4 rounded-2xl border-2 backdrop-blur-3xl transition-all ${
                                        theme === 'dark'
                                    ...
                                    {isDropdownOpen && (
                                        <>
                                            ...
                                            <motion.div
                                                ...
                                                className={`absolute top-full left-0 right-0 mt-3 p-2 rounded-2xl border-2 backdrop-blur-3xl z-20 shadow-2xl ${
                                                    theme === 'dark'
                        ...
                        <AnimatePresence mode="popLayout">
                            {filteredArticles.map((article, idx) => (
                                <motion.div
                                    ...
                                    className={`group cursor-pointer rounded-[2.5rem] overflow-hidden border transition-all duration-500 hover:shadow-2xl ${
                                        theme === 'dark'
                                ...
                                >
                                    ...
                                    <div className="p-8 space-y-4">
                                        ...
                                        <h3 className={`text-xl md:text-2xl font-black leading-tight tracking-tight group-hover:text-[#eab308] transition-colors ${
                                            theme === 'dark' ? 'text-white' : 'text-black'
                                        }`}>
                                            {article.title[language]}
                                        </h3>

                                        <p className={`text-sm leading-relaxed line-clamp-2 opacity-60 ${
