...
const TWO_PI = 6.283185307179586; // Math.PI ашиглахгүй
...
const SCENES: Scene[] = [
  ...
  },
  {
    ...
    parts: [
      ...
      // ✅ ЭНЭ 2 transform одоо ажиллана (доор motion transform дарж устгахгүй)
...
/** ⚡ scribbleOut үед RGB split glitch */
...
function SceneSVG({
  ...
  const isOld = scene.key === "old";
  const outSeconds = (scene.scribbleOutMs ?? 640) / 1000;

  // hold үед “амьд” жижиг хөдөлгөөн
  ...
  // ✅ old->final үед: explode биш, “morph vibe”
  // хэсгүүд төв рүү шахагдаж + томорч + бүдгэрнэ
  const sceneMorph = morphingToNext
    ? { scale: [1, 1.08], rotate: [0, 12], opacity: [1, 0.35] }
    : {};
      ...
      <motion.g animate={{ ...holdWobble, ...sceneMorph }} transition={morphingToNext ? sceneMorphT : holdWobbleT}>
        <g transform={scene.sceneTransform}>
          {scene.parts.map((part, i) => {
            ...
            // ✅ per-part morph: old->final үед жаахан "zoom in" мэдрэмж
            ...
            // ✅ ГОЛ ЗАСВАР:
            // Framer Motion transform-оо дарж бичдэг тул motion.g дээр transform аттрибут бүү тавь.
            // Харин статик transform-оо ДАРААХ энгийн <g transform="..."> дотор хий.
            return (
...
export default function IntroAnimation() {
  ...
  // ✅ second -> final morph trigger: зөвхөн old scene scribbleOut үед
  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center pointer-events-none">
      ...
      <div className="relative w-[320px] h-[320px] md:w-[540px] md:h-[540px]">
        {/* scribble FX */}
