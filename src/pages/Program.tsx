...
const Program = () => {
  ...
  const surgaltuudList = [
    { id: 1, name: 'Scratch Pixels', category: 'zuslaan', tag: language === 'mn' ? 'Зуслан' : 'Summer', tagColor: 'bg-green-500', price: '₮850,000', description: language === 'mn' ? '9-11 насны хүүхдүүдэд зориулагдсан програмчлалын анхан шатны сургалт' : 'Beginner programming course for ages 9-11', duration: language === 'mn' ? '5 өдөр' : '5 days', age: language === 'mn' ? '9-11 нас' : '9-11 years', level: language === 'mn' ? 'Анхан шат' : 'Beginner', color: 'from-green-400 to-emerald-600', icon: 'fa-gamepad', image: scratchpixelImage },
    { id: 2, name: 'Zero 2 Hero', category: 'zuslaan', tag: language === 'mn' ? 'Зуслан' : 'Summer', tagColor: 'bg-green-500', price: '₮850,000', description: language === 'mn' ? '12-16 насныханд зориулсан Python хэл дээрх тоглоом хөгжүүлэлтийн сургалт' : 'Python game development course for ages 12-16', duration: language === 'mn' ? '5 өдөр' : '5 days', age: language === 'mn' ? '12-16 нас' : '12-16 years', level: language === 'mn' ? 'Суурь - Дунд шат' : 'Foundation - Intermediate', color: 'from-orange-400 to-red-500', icon: 'fa-code', image: zerotoheroImage },
    { id: 3, name: 'Electrikid', category: 'zuslaan', tag: language === 'mn' ? 'Зуслан' : 'Summer', tagColor: 'bg-green-500', price: '₮850,000', description: language === 'mn' ? '9-13 насныханд зориулсан электроникийн анхан шатны сургалт' : 'Electronics beginner course for ages 9-13', duration: language === 'mn' ? '5 өдөр' : '5 days', age: language === 'mn' ? '9-13 нас' : '9-13 years', level: language === 'mn' ? 'Анхан шат' : 'Beginner', color: 'from-cyan-400 to-blue-500', icon: 'fa-bolt', image: electrikidImage },
    { id: 4, name: 'Electrikid Crash Course', category: 'bogino', tag: language === 'mn' ? 'Богино хугацааны' : 'Short-term', tagColor: 'bg-orange-500', price: '₮350,000', description: language === 'mn' ? '9-13 насныханд зориулсан электроникийн тургавчилсан сургалт' : 'Intensive electronics course for ages 9-13', duration: language === 'mn' ? '3 өдөр' : '3 days', age: language === 'mn' ? '9-13 нас' : '9-13 years', level: language === 'mn' ? 'Анхан шат' : 'Beginner', color: 'from-purple-400 to-violet-600', icon: 'fa-plug', image: electrikidImage },
    { id: 5, name: 'Web Design 101', category: 'bogino', tag: language === 'mn' ? 'Богино хугацааны' : 'Short-term', tagColor: 'bg-orange-500', price: '₮250,000', description: language === 'mn' ? 'Вэб дизайн, HTML/CSS-ийн суурь сургалт' : 'Web design and HTML/CSS basics course', duration: language === 'mn' ? '4 долоо хоног (8 цаг)' : '4 weeks (8 hrs)', age: language === 'mn' ? '12-16 нас' : '12-16 years', level: language === 'mn' ? 'Анхан шат' : 'Beginner', color: 'from-orange-400 to-pink-500', icon: 'fa-globe', image: null },
    { id: 6, name: 'Python Programmer', category: 'bogino', tag: language === 'mn' ? 'Богино хугацааны' : 'Short-term', tagColor: 'bg-orange-500', price: '₮300,000', description: language === 'mn' ? 'Python програмчлалын анхан шатны сургалт' : 'Python programming beginner course', duration: language === 'mn' ? '6 долоо хоног (12 цаг)' : '6 weeks (12 hrs)', age: language === 'mn' ? '11-15 нас' : '11-15 years', level: language === 'mn' ? 'Анхан шат' : 'Beginner', color: 'from-blue-400 to-cyan-500', icon: 'fa-laptop-code', image: null },
  ];
