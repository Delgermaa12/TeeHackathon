...
export const mockAppreciations: Appreciation[] = [
    ...
    {
        id: 'ap3',
        sender: 'Сурагч Тэмүүлэн',
        targetType: 'teacher',
        targetId: 't2',
        messagePreview: 'Ганзориг багш маш сайхан заадаг...',
        fullMessage: 'Ганзориг багш маш сайхан заадаг. Роботикийн хичээлд би анхны робот бүтээсэн. Одоо гэртээ ч робот хийж чаддаг болсон!',
        visibility: 'public',
        featured: true,
        status: 'approved',
    ...
    {
        id: 'ap4',
        sender: 'Эцэг эх Сарантуяа',
        targetType: 'program',
        targetId: 'p2',
        messagePreview: 'Робототехникийн хөтөлбөр үнэхээр гайхалтай...',
        fullMessage: 'Робототехникийн хөтөлбөр үнэхээр гайхалтай. Миний охин одоо асуудлыг шийдвэрлэх чадвартай болсон. Математикийн дүн нь ч сайжирсан.',
        visibility: 'public',
        featured: true,
        status: 'approved',
    ...
    {
        id: 'ap5',
        sender: 'Сурагч Энхжин',
        targetType: 'program',
        targetId: 'p3',
        messagePreview: '3-р ангийн хөтөлбөр маш сонирхолтой байсан...',
        fullMessage: '3-р ангийн хөтөлбөр маш сонирхолтой байсан. Би одоо Scratch програмчлал мэддэг болсон. Ирээдүйд програм хангамжийн инженер болмоор байна.',
        visibility: 'public',
        featured: true,
        status: 'approved',
    ...
    {
        id: 'ap6',
        sender: 'Эцэг эх Батсайхан',
        targetType: 'teacher',
        targetId: 't3',
        messagePreview: 'Номин багш хүүхдүүдийг маш сайхан удирдан чиглүүлдэг...',
        fullMessage: 'Номин багш хүүхдүүдийг маш сайхан удирдан чиглүүлдэг. Миний хүү AI-ийн талаар их зүйл сурсан. Одоо ChatGPT-г хэрхэн ашиглахыг мэддэг болсон.',
        visibility: 'public',
        featured: true,
        status: 'approved',
